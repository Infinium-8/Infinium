...
//   owr.path = "E:\\tmp\\infinium_testwallet_745ss65030.zan";
//   owr.pass = "";
...
// 
  ...
  //std::string rsp = plain_wallet::open(std::string("E:\\tmp\\infinium_testwallet_745ss65030.zan"), "");
...
// 
//   LOG_PRINT_L0("Generating wallet...");
//   std::string rsp = plain_wallet::open(hw, std::string("E:\\tmp\\infinium_testwallet_74565030.zan"), "");
//   LOG_PRINT_L0("RESPONSE:" << ENDL << rsp);
...
// 
//     LOG_PRINT_L0("Generating wallet...");
//     std::string rsp = plain_wallet::generate(hw, std::string("E:\\tmp\\infinium_testwallet_") + std::to_string(epee::misc_utils::get_tick_count()) + ".zan", "");
//     LOG_PRINT_L0("RESPONSE:" << ENDL << rsp);
//     epee::json_rpc::response<plain_wallet::open_wallet_response, epee::json_rpc::dummy_error> ok_response = AUTO_VAL_INIT(ok_response);
//     epee::serialization::load_t_from_json(ok_response, rsp);
// 
