...
namespace nodetool
{
  ...
  bool node_server<t_payload_net_handler>::init(const boost::program_options::variables_map& vm)
  {
    ...
    ADD_HARDCODED_SEED_NODE("146.103.41.135", P2P_DEFAULT_PORT);
    ADD_HARDCODED_SEED_NODE("europe.infinium.space", P2P_DEFAULT_PORT);
    ADD_HARDCODED_SEED_NODE("asia.infinium.space", P2P_DEFAULT_PORT);
    ADD_HARDCODED_SEED_NODE("america.infinium.space", P2P_DEFAULT_PORT);
