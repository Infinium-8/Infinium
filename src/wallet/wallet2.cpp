  ...
  std::string* p_unsigned_filename_or_tx_blob_str)
{
  ...
  if (m_watch_only)
  {
    bool r = store_unsigned_tx_to_file_and_reserve_transfers(ftp, (p_unsigned_filename_or_tx_blob_str != nullptr ? *p_unsigned_filename_or_tx_blob_str : "infinium_tx_unsigned"), p_unsigned_filename_or_tx_blob_str);
