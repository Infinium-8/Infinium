...
#define ANDROID_PACKAGE_NAME    "com.infinium_mobile"
...
namespace plain_wallet
{
  ...
  std::string get_export_private_info(const std::string& target_dir)
  {
    ...
    boost::system::error_code ec;
    const std::string full_target_path = target_dir + "/infinium_export" + std::to_string(epee::misc_utils::get_tick_count());
